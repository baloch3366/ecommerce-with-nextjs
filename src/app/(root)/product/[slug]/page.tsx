        ...
        <div className="grid grid-cols-1 md:grid-cols-5">
          ...
          <div className="flex flex-col w-full gap-2 md:p-5 col-span-2">
            <div className="flex flex-col gap-3">
              <p className="text-[16px] font-medium rounded-full bg-gray-500/10 text-gray-500">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-[16px] font-medium lg:text-[18px]">
                {product.description}
              </p>
            </div>
          </div>
            ...
            <Card>
              <CardContent className="flex flex-col p-4 gap-4">
                ...
                {product.countInStock !== 0 ? (
                  <div className="text-green text-xl">In Stock</div>
                ) : (
