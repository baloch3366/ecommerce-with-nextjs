...
export default async function SearchPage(props: {
  ...
  return (
    <div>
      <div className='mb-2 px-3 py-2 md:border-b flex-between flex-col md:flex-row '>
      ...
      <div className=' px-3 bg-card grid md:grid-cols-5 md:gap-4'>
                  ...
                  >
                    <div className='flex'>
                      ...
                      {ratings.map((r) => (
                        <li key={r}>
                          <Link
                            href={getFilterUrl({ rating: r.toString(), params })}
                            className={`${rating === r.toString() && 'text-primary'}`}
                          >
                            <div className="flex">
                              <Rating size={4} rating={r} /> & Up
                              {/* // size = {4 } means 4px */}
                            </div>
                          </Link>
                        </li>
